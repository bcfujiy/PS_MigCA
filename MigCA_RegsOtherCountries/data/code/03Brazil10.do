...
* Weighting
replace L_ijkt_10 = L_ijkt_10*perwt
...
* collapse
collapse (sum) L_ijkt_10, by(origin destination crop year)
...
save ".././output/L_ijkt_br_10", replace
...
gen w_ijkt_10 = incearn*perwt
bys origin destination crop: egen w_ijkt_10_den = total(perwt)

* collapse
collapse (sum) w_ijkt_10 (mean) w_ijkt_10_den, by(origin destination crop year)

* LHS variable
replace w_ijkt_10 = w_ijkt_10/w_ijkt_10_den
drop w_ijkt_10_den
...
* save
sort origin destination crop year
save ".././output/w_ijkt_br_10", replace
