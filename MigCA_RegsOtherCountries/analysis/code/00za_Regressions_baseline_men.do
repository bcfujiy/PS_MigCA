...
* Tables
noi: esttab reg11_za_ols reg11_za_ppml1 reg11_za_ppml2 reg11_za_ppml3 reg11_za_ols1 using ".././output/reg11_za_men.tex", ///
...
* Tables
noi: esttab reg10_za_ols reg10_za_ppml1 reg10_za_ppml2 reg10_za_ols1 using ".././output/reg10_za_men.tex", ///
se compress drop(_cons) stats(N r2 r2_p, label("Observations" "R2" "Pseudo R2")) ///
label nodepvars nomtitles replace ///
star (* 0.10 ** 0.05 *** 0.01)
