...
reghdfe sample_earn_log L_iktlag_log if N_s == 1 & dim_i != dim_j & sample_L_iktlag != 0, absorb(iota_jkt iota_ijt) vce(cluster iota_jkt)
reghdfe sample_earn_log L_iktlag_log if N_s == 1 & dim_i != dim_j, absorb(iota_jkt iota_ijt) vce(cluster iota_jkt)
