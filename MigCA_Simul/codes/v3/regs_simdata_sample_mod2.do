...
* Open simulated data
import delimited using "$outputs/simulated_sampled_all_mod2.csv", clear
...
noi: esttab reg10_sample_ols_* using "$paper/reg10_sample_mod2_ols.tex", ///
...
noi: esttab reg10_sample_ppml* using "$paper/reg10_sample_mod2_ppml.tex", ///
...
noi: esttab reg10_expect_ols_* using "$paper/reg10_expect_mod2_ols.tex", ///
...
noi: esttab reg10_expect_ppml* using "$paper/reg10_expect_mod2_ppml.tex", ///
...
noi: esttab reg11_sample_ols_* using "$paper/reg11_sample_mod2_ols.tex", ///
se compress drop(_cons) stats(N r2, label("Observations" "R-sq")) ///
label nodepvars nomtitles replace
...
noi: esttab reg11_sample_ppml* using "$paper/reg11_sample_mod2_ppml.tex", ///
se compress drop(_cons) stats(N r2_p, label("Observations" "Pseudo R-sq")) ///
label nodepvars nomtitles replace
...
noi: esttab reg11_expect_ols_* using "$paper/reg11_expect_mod2_ols.tex", ///
se compress drop(_cons) stats(N r2, label("Observations" "R-sq")) ///
label nodepvars nomtitles replace
...
noi: esttab reg11_expect_ppml* using "$paper/reg11_expect_mod2_ppml.tex", ///
se compress drop(_cons) stats(N r2_p, label("Observations" "Pseudo R-sq")) ///
label nodepvars nomtitles replace
