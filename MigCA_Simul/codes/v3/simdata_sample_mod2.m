...
for x = 1:size(sampsize, 2)
    ...
    % Modifying the definition of earnings
    sample_earn = sample_earn./mu_ijkt;
    
    % Zeros for where people do not migrate
...
% Exporting data
csvwrite('../../outputs/simulated_sampled_all_mod2.csv', simulated_sampled_all);
